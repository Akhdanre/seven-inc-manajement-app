                ...
                <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg mx-auto mt-10">
                    ...
                    @csrf
                        <div class="mb-4">
                            ...
                            <input type="number" id="nip" name="nip" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{ old('nip') }}" required>
                        </div>
