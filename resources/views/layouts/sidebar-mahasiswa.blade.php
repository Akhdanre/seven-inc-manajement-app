<aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
    <div class="p-6">
        <a href="#" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">E-Data</a>
    </div>
    <nav class="text-white text-base font-semibold pt-3">
        <a href="" class="{{ Request::is('*home') ? 'active-nav-link' : '' }} flex items-center text-white py-4 pl-6 nav-item">
